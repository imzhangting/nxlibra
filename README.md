...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/kwAd1n7Ckc)
...
```sh
npx nx serve NxLibra
```

To create a production bundle:

```sh
npx nx build NxLibra
```

To see all available targets to run for a project, run:

```sh
npx nx show project NxLibra
```
